<nav class="bg-red-500">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://flowbite.com/" class="flex items-center">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Liverpool FC</span>
    </a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-red-500 md:flex-row md:space-x-8 md:mt-0 md:border-0 border-red-500">
        <li>
          <a href="#" class="block py-2 pl-3 pr-4 text-white bg-white rounded md:bg-transparent text-white md:p-0 text-white md:dark:text-blue-500" aria-current="page">Home</a>
        </li>
        <li>
